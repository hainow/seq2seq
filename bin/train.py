...
tf.flags.DEFINE_integer("eval_every_n_steps", 100,
...
tf.flags.DEFINE_integer("keep_checkpoint_every_n_hours", 4,
                        ...
                        training.""")
tf.flags.DEFINE_float("gpu_memory_fraction", 0.7,  # change to 0.7
                      """Fraction of GPU memory used by the process on
                      each GPU uniformly on the same machine.""")
tf.flags.DEFINE_boolean("gpu_allow_growth", True,  # change to True
...
def create_experiment(output_dir):
  ...
  # basically stores model and model_params
  # e.g. model == image2seq
  ...
  dev_input_pipeline = input_pipeline.make_input_pipeline_from_def(
    ...
    shuffle=False,
    num_epochs=1)  # Hai changed this from 1 to None
  ...
  def model_fn(features, labels, params, mode):
    ...
    # call model not by __init__ BUT by __call__()
  ...
  experiment = PatchedExperiment(
    ...
    train_steps=FLAGS.train_steps,  # export TRAIN_STEPS=1000, pass as a param
    eval_steps=None,
